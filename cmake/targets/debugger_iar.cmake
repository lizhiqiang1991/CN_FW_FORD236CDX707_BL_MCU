function(create_iar_debugger_targets)
    ...
    # Create variable with the correct setting string for configuring the IAR debug template files
    if(${IAR_DEBUG_HW_ADAPTER} STREQUAL I-jet)
        set(IAR_DEBUG_HW_ID_STRING IJET_ID)
    elseif(${IAR_DEBUG_HW_ADAPTER} STREQUAL CMSIS-DAP)
        set(IAR_DEBUG_HW_ID_STRING CMSISDAP_ID)
    else()
        message(FATAL_ERROR "Selected IAR_DEBUG_HW_ADAPTER (${IAR_DEBUG_HW_ADAPTER}) is unknown or unsupported!")
    endif()
